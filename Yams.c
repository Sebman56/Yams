...
/************************************************************************ */
/* ***************** Developpement des fonctions des gestions des joueurs */
/************************************************************************ */
int main()
{
    NombreDeJoueur();
...
//   int Etat[NPlayer][5];
   ...
   printf(" \n Tour Joueur %i: %i, %i, %i, %i, %i", NoJoueur, Etat[NoJoueur][1], Etat[NoJoueur][2], Etat[NoJoueur][3], Etat[NoJoueur][4], Etat[NoJoueur][5]);
   // Lecture ();
}
