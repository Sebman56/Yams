...
//            printf("\033[2J\033[H"); // Efface l'écran et déplace le curseur en haut à gauche
            ...
            while (LigneRemplie<1)
            {
                ...
                if (LignePartie < 1 || LignePartie > nbLignes || LignePartie == 7 || LignePartie == 8 || LignePartie == 16) 
                    {
                ...
                else
                    {
                        ...
                        PremierTotal = ScorePartie[1][Manche]+ScorePartie[2][Manche]+ScorePartie[3][Manche]+ScorePartie[4][Manche]+ScorePartie[5][Manche]+ScorePartie[6][Manche];
                        ScorePartie[7][Manche] = PremierTotal;

                        DeuxiemeTotal = ScorePartie[7][Manche]+ ScorePartie[8][Manche]+ScorePartie[9][Manche]+ScorePartie[10][Manche]+ScorePartie[11][Manche]+ScorePartie[12][Manche]+ScorePartie[13][Manche]+ScorePartie[14][Manche]+ScorePartie[15][Manche];
                        ScorePartie[15][Manche] = DeuxiemeTotal;
